...
# =========================================================
# ?숋툘 FULL TRAINING Config (ProtT5)
# =========================================================
...
EPOCHS = 12
NUM_WORKERS = 4
SAVE_THRESHOLD = 0.001 
TOP_K = 300 

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
print(f"?뵦 Device: {device} | FULL Training: ProtT5-XL (100% Data)")
...
def main():
    ...
    model.eval()
    out_file = os.path.join(OUTPUT_DIR, "final_prott5_full.tsv")
